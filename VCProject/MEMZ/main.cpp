...
const char *sites[] = {
	"https://google.co.ck/search?q=best+way+to+kill+your+computer",
	"https://google.co.ck/search?q=how+2+install+a+virus",
	"https://google.co.ck/search?q=mcafee+vs+norton+vs+trojan",
	"https://google.co.ck/search?q=how+to+send+a+virus+to+my+friend",
	"https://google.co.ck/search?q=minecraft+hax+download+no+virus",
	"https://google.co.ck/search?q=how+to+get+ransomware",
	...
	"https://google.co.ck/search?q=internet+explorer+is+the+best+browser+on+windows+98",
